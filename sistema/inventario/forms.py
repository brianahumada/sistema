...
from .models import Usuario, Producto, Cliente, Opciones
...
class UsuarioFormulario(forms.Form):
    ...
    class Meta:
        model = Usuario
        fields = ['username', 'email', 'first_name', 'last_name', 'nivel', 'is_active', 'is_staff']
...
class OpcionesFormulario(forms.Form):
    ...
    class Meta:
        model = Opciones
        fields = ['moneda', 'valor_iva', 'nombre_negocio', 'mensaje_factura ']
