...
class Usuario(AbstractUser):
    ...
    password = models.CharField(max_length=20)  # No se recomienda almacenar contraseñas en campos de texto plano
    ...
    @classmethod
    def numero_registrados(cls):
        return cls.objects.all().count()

    @classmethod
    def numero_usuarios(cls, tipo):
    ...
    class Meta:
        # Asegúrate de que el app_label sea el mismo que el nombre de la app en la que está definido este modelo
        app_label = 'inventario'

    # Define los accesos inversos únicos para evitar el conflicto
    groups = models.ManyToManyField(
        'auth.Group',
        related_name='usuarios',  # Cambiado a 'usuarios'
        blank=True,
        verbose_name='groups',
    ...
    user_permissions = models.ManyToManyField(
        'auth.Permission',
        related_name='usuarios_permissions',  # Cambiado a 'usuarios_permissions'
        blank=True,
